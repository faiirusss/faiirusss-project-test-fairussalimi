...
<body>
            ...
            <div class="container">
                ...
                <div class="nav-link">
                    <li class="nav-list">
                        ...
                        <ul><a href="#" class="nav-item active">Ideas</a></ul>
                        <ul><a href="careers.php" class="nav-item">Careers</a></ul>
                        <ul><a href="contact.php" class="nav-item">Contact</a></ul>
                    </li>
                </div>
            </div>
        </nav>
    ...
    <main>
        <section class="mb-5">
            <div class="container text-center" id="artikelContainer">
    ...
    <!-- Tambahkan skrip berikut setelah Anda menyertakan jQuery -->
    <script>
        $(document).ready(function() {
            $("#showPerPage").on('change', function() {
                ...
                $.ajax({
                    url: "fetch.php", // Sesuaikan dengan path file yang benar
                    type: "POST",
                    data: {
                        request: selectedValue
                    },
                    beforeSend: function() {
                        // Menampilkan pesan loading atau animasi loading jika diperlukan
                    },
                    success: function(data) {
                        // Mengganti isi dari kontainer artikel dengan hasil dari Ajax
